...
i18n.use(initReactI18next).init({
  ...
  defaultNS: 'common',
  resources: {
    es: { common: esCommon, dashboard: esDashboard, attendance: esAttendance, people: esPeople, blog: esBlog },
    en: { common: enCommon, dashboard: enDashboard, attendance: enAttendance, people: enPeople, blog: enBlog },
  },
  interpolation: {
    escapeValue: false,
  },
