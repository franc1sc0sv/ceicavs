...
const NAV_ITEMS: NavItem[] = [
  ...
  { to: '/people', labelKey: 'nav.people', icon: Users, permission: { action: Action.CREATE, subject: Subject.GROUP } },
  { to: '/blog', labelKey: 'nav.blog', icon: FileText },
  { to: '/tools', labelKey: 'nav.tools', icon: Wrench },
  { to: '/transcription', labelKey: 'nav.transcription', icon: AudioLines, permission: { action: Action.CREATE, subject: Subject.RECORDING } },
]
