...
import { RemoveMemberFromGroupCommand } from './remove-member-from-group.command'

@CommandHandler(RemoveMemberFromGroupCommand)
export class RemoveMemberFromGroupHandler extends BaseCommandHandler<RemoveMemberFromGroupCommand, void> {
  constructor(
  ...
  protected async handle(
    command: RemoveMemberFromGroupCommand,
    tx: TxClient,
    ...
    await this.groupRepository.removeMember(command.groupId, command.userId, tx)
  }
}
